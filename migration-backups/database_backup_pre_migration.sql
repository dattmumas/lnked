...
CREATE TYPE "public"."chain_reaction_type" AS ENUM (
    'like',
    'rechain'
);


ALTER TYPE "public"."chain_reaction_type" OWNER TO "postgres";
...
ALTER TYPE "public"."chain_status" OWNER TO "postgres";


CREATE TYPE "public"."chain_visibility" AS ENUM (
    'public',
    'followers',
    'private',
    'unlisted'
...
ALTER TYPE "public"."chain_visibility" OWNER TO "postgres";
...
ALTER TYPE "public"."comment_entity_type" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."add_comment_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_user_id" "uuid", "p_content" "text", "p_parent_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("comment_id" "uuid", "thread_depth" integer)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_depth INTEGER := 0;
...
ALTER FUNCTION "public"."add_comment_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_user_id" "uuid", "p_content" "text", "p_parent_id" "uuid") OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."video_assets"."is_public" IS 'Whether the video is publicly accessible';



COMMENT ON COLUMN "public"."video_assets"."playback_policy" IS 'MUX playback policy: public or signed';



COMMENT ON COLUMN "public"."video_assets"."encoding_tier" IS 'MUX encoding tier: smart or baseline';



COMMENT ON COLUMN "public"."video_assets"."collective_id" IS 'Associated collective for collective-specific videos';



COMMENT ON COLUMN "public"."video_assets"."post_id" IS 'Associated post for video-post integration';
...
CREATE OR REPLACE FUNCTION "public"."get_comment_count_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid") RETURNS integer
...
ALTER FUNCTION "public"."get_comment_count_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_comment_replies_v2"("p_parent_id" "uuid", "p_limit" integer DEFAULT 10, "p_offset" integer DEFAULT 0) RETURNS TABLE("comment_data" "jsonb")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_comment_replies_v2"("p_parent_id" "uuid", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_comment_thread_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_limit" integer DEFAULT 20, "p_offset" integer DEFAULT 0) RETURNS TABLE("comment_data" "jsonb")
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_comment_thread_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_following"("follower_user_id" "uuid", "target_id" "uuid", "target_type" "text" DEFAULT 'user'::"text") RETURNS boolean
...
ALTER FUNCTION "public"."tg_chain_like_count"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."tg_chains_set_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."toggle_comment_reaction_v2"("p_comment_id" "uuid", "p_user_id" "uuid", "p_reaction_type" "public"."reaction_type") RETURNS TABLE("action_taken" "text", "reaction_counts" "jsonb")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."toggle_comment_reaction_v2"("p_comment_id" "uuid", "p_user_id" "uuid", "p_reaction_type" "public"."reaction_type") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_comment_timestamp_v2"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_comment_timestamp_v2"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_reply_count_on_delete_v2"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_reply_count_on_delete_v2"() OWNER TO "postgres";
...
ALTER TABLE "public"."chain_bookmarks" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."chain_reactions" (
    "chain_id" "uuid" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "reaction" "public"."chain_reaction_type" DEFAULT 'like'::"public"."chain_reaction_type" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "public"."chain_reactions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."chains" (
    ...
    "visibility" "public"."chain_visibility" DEFAULT 'public'::"public"."chain_visibility" NOT NULL,
    "status" "public"."chain_status" DEFAULT 'active'::"public"."chain_status" NOT NULL,
    "like_count" integer DEFAULT 0 NOT NULL,
    "reply_count" integer DEFAULT 0 NOT NULL,
    "meta" "jsonb" DEFAULT '{}'::"jsonb",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "tsv" "tsvector" GENERATED ALWAYS AS ("setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("content", ''::"text")), 'A'::"char")) STORED,
    CONSTRAINT "chains_content_check" CHECK (("char_length"("content") <= 1024))
);
...
CREATE TABLE IF NOT EXISTS "public"."comment_pins_v2" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."comment_pins_v2" OWNER TO "postgres";


COMMENT ON TABLE "public"."comment_pins_v2" IS 'Comments pinned by entity owners';
...
CREATE TABLE IF NOT EXISTS "public"."comment_reactions_v2" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "comment_id" "uuid" NOT NULL,
    "user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."comment_reactions_v2" OWNER TO "postgres";


COMMENT ON TABLE "public"."comment_reactions_v2" IS 'Reactions (like, heart, etc.) on comments';



CREATE TABLE IF NOT EXISTS "public"."comment_reports_v2" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "comment_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."comment_reports_v2" OWNER TO "postgres";


COMMENT ON TABLE "public"."comment_reports_v2" IS 'User reports for content moderation';
...
CREATE TABLE IF NOT EXISTS "public"."comments_v2" (
    ...
    CONSTRAINT "valid_thread_depth" CHECK (((("parent_id" IS NULL) AND ("thread_depth" = 0)) OR (("parent_id" IS NOT NULL) AND ("thread_depth" > 0))))
);
...
COMMENT ON TABLE "public"."comments_v2" IS 'Universal polymorphic comment system supporting any entity type';



COMMENT ON COLUMN "public"."comments_v2"."entity_type" IS 'Type of entity this comment belongs to (video, post, collective, profile)';



COMMENT ON COLUMN "public"."comments_v2"."entity_id" IS 'ID of the entity this comment belongs to';



COMMENT ON COLUMN "public"."comments_v2"."thread_depth" IS 'Depth in the comment thread (0 = top level, 1+ = reply)';



COMMENT ON COLUMN "public"."comments_v2"."reply_count" IS 'Cached count of direct replies to this comment';



COMMENT ON COLUMN "public"."comments_v2"."metadata" IS 'Additional comment metadata (mentions, formatting, etc.)';
...
CREATE OR REPLACE VIEW "public"."search_documents" AS
 SELECT 'collective'::"text" AS "document_type",
    "collectives"."id" AS "document_id",
    "collectives"."name" AS "title",
    "collectives"."description" AS "content_preview",
    ("setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("collectives"."name", ''::"text")), 'A'::"char") || "setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("collectives"."description", ''::"text")), 'B'::"char")) AS "tsv_document"
   FROM "public"."collectives"
UNION ALL
 SELECT 'user'::"text" AS "document_type",
    "users"."id" AS "document_id",
    "users"."full_name" AS "title",
    "users"."bio" AS "content_preview",
    ("setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("users"."full_name", ''::"text")), 'A'::"char") || "setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("users"."bio", ''::"text")), 'B'::"char")) AS "tsv_document"
   FROM "public"."users"
UNION ALL
 SELECT 'post'::"text" AS "document_type",
    "posts"."id" AS "document_id",
    "posts"."title",
    "left"("posts"."content", 200) AS "content_preview",
    ("setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("posts"."title", ''::"text")), 'A'::"char") || "setweight"("to_tsvector"('"simple"'::"regconfig", COALESCE("posts"."content", ''::"text")), 'B'::"char")) AS "tsv_document"
   FROM "public"."posts"
  WHERE (("posts"."is_public" = true) AND ("posts"."status" = 'active'::"public"."post_status_type"))
UNION ALL
 SELECT 'chain'::"text" AS "document_type",
    "chains"."id" AS "document_id",
    "substr"("chains"."content", 1, 100) AS "title",
    "substr"("chains"."content", 1, 200) AS "content_preview",
    "chains"."tsv" AS "tsv_document"
   FROM "public"."chains"
  WHERE (("chains"."visibility" = 'public'::"public"."chain_visibility") AND ("chains"."status" = 'active'::"public"."chain_status"));
...
ALTER TABLE ONLY "public"."chain_bookmarks"
    ADD CONSTRAINT "chain_bookmarks_pkey" PRIMARY KEY ("user_id", "chain_id");



ALTER TABLE ONLY "public"."chain_reactions"
    ADD CONSTRAINT "chain_reactions_pkey" PRIMARY KEY ("chain_id", "user_id", "reaction");
...
ALTER TABLE ONLY "public"."comment_pins_v2"
    ADD CONSTRAINT "comment_pins_v2_entity_type_entity_id_comment_id_key" UNIQUE ("entity_type", "entity_id", "comment_id");



ALTER TABLE ONLY "public"."comment_pins_v2"
    ADD CONSTRAINT "comment_pins_v2_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."comment_reactions_v2"
    ADD CONSTRAINT "comment_reactions_v2_comment_id_user_id_reaction_type_key" UNIQUE ("comment_id", "user_id", "reaction_type");



ALTER TABLE ONLY "public"."comment_reactions_v2"
    ADD CONSTRAINT "comment_reactions_v2_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."comment_reports_v2"
    ADD CONSTRAINT "comment_reports_v2_comment_id_reporter_id_key" UNIQUE ("comment_id", "reporter_id");



ALTER TABLE ONLY "public"."comment_reports_v2"
    ADD CONSTRAINT "comment_reports_v2_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."comments_v2"
    ADD CONSTRAINT "comments_v2_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."comments_v2"
    ADD CONSTRAINT "unique_entity_comment" UNIQUE ("entity_type", "entity_id", "id");
...
CREATE INDEX "chains_author_created_idx" ON "public"."chains" USING "btree" ("author_id", "created_at" DESC);



CREATE INDEX "chains_parent_idx" ON "public"."chains" USING "btree" ("parent_chain_id");



CREATE INDEX "chains_tsv_idx" ON "public"."chains" USING "gin" ("tsv");



CREATE INDEX "chains_visibility_idx" ON "public"."chains" USING "btree" ("visibility");
...
CREATE INDEX "idx_comment_pins_v2_entity" ON "public"."comment_pins_v2" USING "btree" ("entity_type", "entity_id", "pin_order");



CREATE INDEX "idx_comment_reactions_v2_comment" ON "public"."comment_reactions_v2" USING "btree" ("comment_id", "reaction_type");



CREATE INDEX "idx_comment_reactions_v2_user" ON "public"."comment_reactions_v2" USING "btree" ("user_id", "created_at" DESC);



CREATE INDEX "idx_comment_reports_v2_comment" ON "public"."comment_reports_v2" USING "btree" ("comment_id");



CREATE INDEX "idx_comment_reports_v2_status" ON "public"."comment_reports_v2" USING "btree" ("status", "created_at") WHERE ("status" <> 'resolved'::"public"."report_status");



CREATE INDEX "idx_comments_v2_deleted" ON "public"."comments_v2" USING "btree" ("deleted_at") WHERE ("deleted_at" IS NOT NULL);



CREATE INDEX "idx_comments_v2_entity_created" ON "public"."comments_v2" USING "btree" ("entity_type", "entity_id", "created_at" DESC);



CREATE INDEX "idx_comments_v2_parent_created" ON "public"."comments_v2" USING "btree" ("parent_id", "created_at") WHERE ("parent_id" IS NOT NULL);



CREATE INDEX "idx_comments_v2_thread_depth" ON "public"."comments_v2" USING "btree" ("thread_depth") WHERE ("thread_depth" > 0);



CREATE INDEX "idx_comments_v2_user_created" ON "public"."comments_v2" USING "btree" ("user_id", "created_at" DESC);
...
CREATE INDEX "idx_video_assets_post_id" ON "public"."video_assets" USING "btree" ("post_id");
...
CREATE OR REPLACE TRIGGER "trg_chain_like_count_del" AFTER DELETE ON "public"."chain_reactions" FOR EACH ROW EXECUTE FUNCTION "public"."tg_chain_like_count"();



CREATE OR REPLACE TRIGGER "trg_chain_like_count_ins" AFTER INSERT ON "public"."chain_reactions" FOR EACH ROW EXECUTE FUNCTION "public"."tg_chain_like_count"();
...
CREATE OR REPLACE TRIGGER "trg_set_updated_at_chains" BEFORE UPDATE ON "public"."chains" FOR EACH ROW EXECUTE FUNCTION "public"."tg_chains_set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trigger_update_comment_timestamp_v2" BEFORE UPDATE ON "public"."comments_v2" FOR EACH ROW EXECUTE FUNCTION "public"."update_comment_timestamp_v2"();



CREATE OR REPLACE TRIGGER "trigger_update_reply_count_on_delete_v2" AFTER DELETE ON "public"."comments_v2" FOR EACH ROW EXECUTE FUNCTION "public"."update_reply_count_on_delete_v2"();
...
ALTER TABLE ONLY "public"."chain_bookmarks"
    ADD CONSTRAINT "chain_bookmarks_chain_id_fkey" FOREIGN KEY ("chain_id") REFERENCES "public"."chains"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chain_bookmarks"
    ADD CONSTRAINT "chain_bookmarks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chain_reactions"
    ADD CONSTRAINT "chain_reactions_chain_id_fkey" FOREIGN KEY ("chain_id") REFERENCES "public"."chains"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chain_reactions"
    ADD CONSTRAINT "chain_reactions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chains"
    ADD CONSTRAINT "chains_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chains"
    ADD CONSTRAINT "chains_collective_id_fkey" FOREIGN KEY ("collective_id") REFERENCES "public"."collectives"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."chains"
    ADD CONSTRAINT "chains_parent_chain_id_fkey" FOREIGN KEY ("parent_chain_id") REFERENCES "public"."chains"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."comment_pins_v2"
    ADD CONSTRAINT "comment_pins_v2_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "public"."comments_v2"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."comment_pins_v2"
    ADD CONSTRAINT "comment_pins_v2_pinned_by_fkey" FOREIGN KEY ("pinned_by") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."comment_reactions_v2"
    ADD CONSTRAINT "comment_reactions_v2_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "public"."comments_v2"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."comment_reactions_v2"
    ADD CONSTRAINT "comment_reactions_v2_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."comment_reports_v2"
    ADD CONSTRAINT "comment_reports_v2_comment_id_fkey" FOREIGN KEY ("comment_id") REFERENCES "public"."comments_v2"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."comment_reports_v2"
    ADD CONSTRAINT "comment_reports_v2_moderator_id_fkey" FOREIGN KEY ("moderator_id") REFERENCES "public"."users"("id");



ALTER TABLE ONLY "public"."comment_reports_v2"
    ADD CONSTRAINT "comment_reports_v2_reporter_id_fkey" FOREIGN KEY ("reporter_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."comments_v2"
    ADD CONSTRAINT "comments_v2_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."comments_v2"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."comments_v2"
    ADD CONSTRAINT "comments_v2_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Collective videos are viewable by collective members" ON "public"."video_assets" FOR SELECT USING ((("collective_id" IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."collective_members"
  WHERE (("collective_members"."collective_id" = "video_assets"."collective_id") AND ("collective_members"."member_id" = "auth"."uid"()) AND ("collective_members"."member_type" = 'user'::"public"."member_entity_type"))))));
...
CREATE POLICY "Private videos are viewable by owner only" ON "public"."video_assets" FOR SELECT USING ((("created_by" = "auth"."uid"()) AND (("is_public" = false) OR ("is_public" IS NULL))));



CREATE POLICY "Public videos are viewable by everyone" ON "public"."video_assets" FOR SELECT USING (("is_public" = true));
...
CREATE POLICY "delete_own_chains" ON "public"."chains" FOR DELETE USING (("auth"."uid"() = "author_id"));
...
CREATE POLICY "insert_chains" ON "public"."chains" FOR INSERT WITH CHECK (("auth"."uid"() = "author_id"));
...
CREATE POLICY "mutate_own_chains" ON "public"."chains" FOR UPDATE USING (("auth"."uid"() = "author_id")) WITH CHECK (("auth"."uid"() = "author_id"));
...
CREATE POLICY "own_chain_bookmarks" ON "public"."chain_bookmarks" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "own_chain_reactions" ON "public"."chain_reactions" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "read_chains" ON "public"."chains" FOR SELECT USING ((("visibility" = 'public'::"public"."chain_visibility") OR (("visibility" = 'followers'::"public"."chain_visibility") AND "public"."is_following"("auth"."uid"(), "author_id", 'user'::"text")) OR ("auth"."uid"() = "author_id")));
...
GRANT ALL ON FUNCTION "public"."add_comment_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_user_id" "uuid", "p_content" "text", "p_parent_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."add_comment_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_user_id" "uuid", "p_content" "text", "p_parent_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."add_comment_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_user_id" "uuid", "p_content" "text", "p_parent_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_comment_count_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_comment_count_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_comment_count_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_comment_replies_v2"("p_parent_id" "uuid", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_comment_replies_v2"("p_parent_id" "uuid", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_comment_replies_v2"("p_parent_id" "uuid", "p_limit" integer, "p_offset" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."get_comment_thread_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_limit" integer, "p_offset" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_comment_thread_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_limit" integer, "p_offset" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_comment_thread_v2"("p_entity_type" "public"."comment_entity_type", "p_entity_id" "uuid", "p_limit" integer, "p_offset" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."tg_chain_like_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."tg_chain_like_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."tg_chain_like_count"() TO "service_role";



GRANT ALL ON FUNCTION "public"."tg_chains_set_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."tg_chains_set_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."tg_chains_set_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."toggle_comment_reaction_v2"("p_comment_id" "uuid", "p_user_id" "uuid", "p_reaction_type" "public"."reaction_type") TO "anon";
GRANT ALL ON FUNCTION "public"."toggle_comment_reaction_v2"("p_comment_id" "uuid", "p_user_id" "uuid", "p_reaction_type" "public"."reaction_type") TO "authenticated";
GRANT ALL ON FUNCTION "public"."toggle_comment_reaction_v2"("p_comment_id" "uuid", "p_user_id" "uuid", "p_reaction_type" "public"."reaction_type") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_comment_timestamp_v2"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_comment_timestamp_v2"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_comment_timestamp_v2"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_reply_count_on_delete_v2"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_reply_count_on_delete_v2"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_reply_count_on_delete_v2"() TO "service_role";
...
GRANT ALL ON TABLE "public"."chain_bookmarks" TO "anon";
GRANT ALL ON TABLE "public"."chain_bookmarks" TO "authenticated";
GRANT ALL ON TABLE "public"."chain_bookmarks" TO "service_role";



GRANT ALL ON TABLE "public"."chain_reactions" TO "anon";
GRANT ALL ON TABLE "public"."chain_reactions" TO "authenticated";
GRANT ALL ON TABLE "public"."chain_reactions" TO "service_role";
...
GRANT ALL ON TABLE "public"."comment_pins_v2" TO "anon";
GRANT ALL ON TABLE "public"."comment_pins_v2" TO "authenticated";
GRANT ALL ON TABLE "public"."comment_pins_v2" TO "service_role";
...
GRANT ALL ON TABLE "public"."comment_reactions_v2" TO "anon";
GRANT ALL ON TABLE "public"."comment_reactions_v2" TO "authenticated";
GRANT ALL ON TABLE "public"."comment_reactions_v2" TO "service_role";



GRANT ALL ON TABLE "public"."comment_reports_v2" TO "anon";
GRANT ALL ON TABLE "public"."comment_reports_v2" TO "authenticated";
GRANT ALL ON TABLE "public"."comment_reports_v2" TO "service_role";
...
GRANT ALL ON TABLE "public"."comments_v2" TO "anon";
GRANT ALL ON TABLE "public"."comments_v2" TO "authenticated";
GRANT ALL ON TABLE "public"."comments_v2" TO "service_role";
