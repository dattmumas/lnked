...
interface EditPostDetailsClientProps {
  postId: string;
  userCollectives: CollectiveWithPermission[];
}

export function EditPostDetailsClient({
  postId,
  userCollectives,
}: EditPostDetailsClientProps): React.ReactElement {
  ...
  // Convert server-side collective data to format expected for display
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 py-8">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          {/* Collective Selection - Compact version */}
          <Card>
            <CardHeader>
