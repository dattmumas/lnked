...
import { getDOMRangeRect } from '../../../utils/dom/getDOMRangeRect';
import { getSelectedNode } from '../../../utils/dom/getSelectedNode';
import { setFloatingElemPosition } from '../../../utils/dom/setFloatingElemPosition';
...
function TextFormatFloatingToolbar({
  ...
  function mouseUpListener(e: MouseEvent) {
    void e; // Parameter required by interface but not used
