...
export default function ActionsPlugin({
  ...
  void isRichText; // Parameter required by interface but not used in current implementation
  ...
  useEffect(() => {
    return editor.registerUpdateListener(
      ({ dirtyElements, prevEditorState, tags }) => {
        void prevEditorState; // Parameter required by interface but not used
